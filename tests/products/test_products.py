...
class TestProduct:
    ...
    def test_create_product_successfully_no_discount(
    ...
    def test_create_product_successfully_with_discount(
        self, discounted_product: DiscountedProductFactory, db
    ) -> None:
    ...
    def test_adjust_increase_price_successfully(
        self, discounted_product: DiscountedProductFactory, db
    ) -> None:
    ...
    def test_adjust_decrease_price_successfully(
        self, discounted_product: DiscountedProductFactory, db
    ) -> None:
        """Test adjusting the price of a product"""
